...
include('handler/retailerOrderHandler.php');
...
<html>
	<head>
		...
		include('javascript/retailerOrderJS.php');
		include('javascript/retailerAddressJS.php');
		if($_SESSION['retailerOrderState'] == 3)
		{
		include('../braintree-php-2.34.0/braintreeRetailerInitializeJS.php');
		}
	...
	<body>
		...
		<div class='container'>
			...
			<br>
			<br>
			<?php retailerNav("newOrder"); ?>
			<br>
			<br>
			<?php include('feature/checkoutNav.php'); ?>

			<?php include('handler/retailerOrderDisplayHandler.php');?>
