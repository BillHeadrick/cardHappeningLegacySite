...
include('handler/retailerRegistrationHandler.php');
...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Retailers Registration|Card Happening</title>
		...
		include('javascript/retailerRegistrationJS.php');
		?>
	</head>
	<body>
		<div class='container'>
			<?php include('../feature/header.php');  ?>
			<?php include('handler/retailerRegistrationFormDisplay.php'); ?>
		</div>
	</body>
</html>